...
export const DEFAULT_PROJECTS: ProjectBubble[] = [
    { id: 1, projectKey: 'FIN-101', name: 'ERP Migration', service: 'Finance', complexity: 450, value: 480, startDate: new Date(2026, 4, 15) }, // May
    { id: 2, projectKey: 'MKT-202', name: 'Website Redesign', service: 'Marketing', complexity: 200, value: 350, startDate: new Date(2026, 6, 1) }, // July
