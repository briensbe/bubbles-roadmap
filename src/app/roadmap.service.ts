...
export class RoadmapService {
  private projectsSource = signal<ProjectBubble[]>([
    { id: 1, name: 'ERP Migration', service: 'Finance', complexity: 45, value: 48, startDate: new Date(2024, 4, 15) }, // May
    { id: 2, name: 'Website Redesign', service: 'Marketing', complexity: 20, value: 35, startDate: new Date(2024, 6, 1) }, // July
    { id: 3, name: 'Cloud Security Audit', service: 'IT', complexity: 30, value: 15, startDate: new Date(2024, 8, 10) }, // September
    { id: 4, name: 'Recruitment Portal', service: 'HR', complexity: 10, value: 25, startDate: new Date(2024, 5, 20) }, // June
    { id: 5, name: 'Q3 Budget Planning', service: 'Finance', complexity: 5, value: 40, startDate: new Date(2024, 7, 5) }, // August
  ]);
